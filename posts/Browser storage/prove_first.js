{
  ...
  const animation = [
    ...
    },
    {
      ...
      y: 62.5,
      color: '#fff',
      text: 'The server generates a seed for the user',
      textAlign: 'center',
      textBaseline: 'middle',
      bold: false,
      italic: false
        ...
        transition => [
          ...
          ...token.flatMap((shape, index) =>
            expandShape(() => width - 45, 200, 15, shape, { start: 520, end: 0 }, [
              ...transition,
              { prop: 'x', time: { start: 520, end: 525 }, distance: (index - 1) * 30 }
            ])
          )
        ]
      ),
    ...
    },
    {
      ...
      y: 62.5,
      color: '#fff',
      text: 'And the server stores it / the seed',
      textAlign: 'center',
      textBaseline: 'middle',
      bold: false,
      italic: false
  ...
  const render = () => {
    ...
    ctx.textBaseline = 'middle'
    ctx.fillText('New user authentication', width / 2, 25 + borderWidth)
