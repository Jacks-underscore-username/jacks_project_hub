{
  ...
  const animation = [
    ...
    },
    {
      ...
      y: 62.5,
      color: '#fff',
      text: 'Say it wants to encrypt this data',
      textAlign: 'center',
      textBaseline: 'middle',
      bold: false,
      italic: false
        ...
        arr.flatMap(
          ...
          (item, index) =>
            typeof item === 'string'
              ? [
                  {
                    time: { start: index ? 500 : 400, end: 0 },
                    type: 'text',
                    x: () => width / 2 + 15,
                    y: 225 + index * 25,
                    size: 0.75,
              ...
              : item.flatMap((shape, subIndex) =>
                  expandShape(
                    ...
                    {
                      start: index ? 500 : 400,
                      end: arrIndex === 3 ? (index ? 620 : 720) : 0
                    },
                    arrIndex === 3
                      ? index
                        ? [
                            ...
                            { prop: 'y', time: { start: 600, end: 620 }, distance: 75 - index * 25 }
                          ]
                        : [
                            {
                              prop: 'x',
      ...
      ),
    {
      ...
      y: 62.5,
      color: '#fff',
      text: 'First it generates a random salt / iv',
      textAlign: 'center',
      textBaseline: 'middle',
      bold: false,
      italic: false
    ...
    {
      time: { start: 650, end: 750 },
      type: 'text',
      size: 1,
      x: () => width / 2,
      y: 62.5,
      color: '#fff',
      text: 'And uses it to encrypt the data',
      textAlign: 'center',
      textBaseline: 'middle',
      bold: false,
      italic: false
    ...
    () =>
      [
        ...
        transition => [
          ...
          ...encryptedData.flatMap((shape, index) =>
            expandShape(() => width - 45, 325, 15, shape, { start: 720, end: 0 }, [
              {
                prop: 'x',
    ...
    {
      time: { start: 750, end: 850 },
      type: 'text',
      size: 1,
      x: () => width / 2,
      y: 62.5,
      color: '#fff',
      text: 'Which can be sent to the server with the salt / iv',
      textAlign: 'center',
      textBaseline: 'middle',
      bold: false,
      italic: false
  ...
  const render = () => {
    ...
    ctx.textBaseline = 'middle'
    ctx.fillText('Saving data', width / 2, 25 + borderWidth)
