const backgroundPaths = ["./posts/Browser storage/background.js","./posts/Making a custom blog/background.js","./backgrounds/fireworks.js","./backgrounds/hiddenSnakes.js","./backgrounds/pong.js","./backgrounds/rain.js","./backgrounds/randomSymbols.js","./backgrounds/uniqueCode.js"];
document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function update() {
    ...
    if (cycle && Date.now() - backgroundStarted >= minTimePerBackground) {
      ...
      if (!loadedBackgrounds.includes(backgroundPaths[backgroundIndex]))
        await new Promise(r => {
